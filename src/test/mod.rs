...
mod tests{
    ...
    //TODO clean up function - remove all test files via Rust -> Dir Walker
    ...
    pub fn test_cleanup() {
        ...
        dbg!(dir.to_str().unwrap().to_owned() + "/tests/");
        //let res = Command::new("sh").arg("cd").arg(dir.to_str().unwrap().to_owned()).arg("&&").arg("ls").output().unwrap(); //.arg("&&").arg("rm").arg("*btree*").output().unwrap();
        assert_eq!(res.stdout, vec![]);
    }*/

    //WARNING: These Tests do not work a second time, as the BFA is persistent ie. files were created and content was inserted
    //Use cleanup function to reset
    #[test]
    ...
    pub fn test_btree_search_none() {
        let mut btree = BTree::new(500,"tests","btree_test_search_none");
        btree.set_up();
        for i in 0..100 {
            let student = Student::new("Witt", "Jonathan", i as usize);
            btree.insert(i ,  student).unwrap();
    ...
    pub fn test_btree_insert_second_of_node_max_3() {
        let mut btree = BTree::new(120,"tests","btree_test_insert_second_of_node_max_3");
        btree.set_up();
        btree.insert(2, 0 as usize).unwrap();
        btree.insert(4, 1 as usize).unwrap();
        btree.insert(6, 2 as usize).unwrap();
    ...
    pub fn test_btree_insert_third_of_node_max_3() {
        let mut btree = BTree::new(120,"tests","btree_test_insert_third_of_node_max_3");
        btree.set_up();
        btree.insert(2, 0 as usize).unwrap();
        btree.insert(4, 1 as usize).unwrap();
        btree.insert(6, 2 as usize).unwrap();
    ...
    pub fn test_btree_insert_fourth_of_node_max_3() {
        let mut btree = BTree::new(120,"tests","btree_test_insert_fourth_of_node_max_3");
        btree.set_up();
        btree.insert(2, 0 as usize).unwrap();
        btree.insert(4, 1 as usize).unwrap();
        btree.insert(6, 2 as usize).unwrap();
    ...
    pub fn test_btree_delete_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete_max_4");
        btree.set_up();
    ...
    pub fn test_btree_delete2_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete2_max_4");
        btree.set_up();
        btree.insert(3, 0 as usize).unwrap();
        btree.insert(4, 1 as usize).unwrap();
        btree.insert(6, 2 as usize).unwrap();
    ...
    pub fn test_btree_delete_join_right_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete_join_right_max_4");
        btree.set_up();
    ...
    pub fn test_btree_delete_fill_with_right_node_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete_fill_with_right_node_max_4");
        btree.set_up();
        btree.insert(4, 0 as usize).unwrap();
        btree.insert(3, 1 as usize).unwrap();
        btree.insert(2, 3 as usize).unwrap();
    ...
    pub fn test_btree_delete_join_left_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete_join_left_max_4");
        btree.set_up();
        btree.insert(2, 3 as usize).unwrap();
        btree.insert(1, 4 as usize).unwrap();
    ...
    pub fn test_btree_delete_fill_with_left_node_max_4() {
        let mut btree = BTree::new(160,"tests","btree_test_delete_fill_with_left_node_max_4");
        btree.set_up();
        btree.insert(12, 7 as usize).unwrap();
    ...
    pub fn test_btree_delete_none_exist() {
        let mut btree = BTree::new(500,"tests","btree_test_delete_none_exist");
        btree.set_up();
        for i in 0..100 {
            let student = Student::new("Witt", "Jonathan", i as usize);
            btree.insert(i ,  student).unwrap();
    ...
    pub fn test_btree_delete_usize_as_comp() {
        let mut btree = BTree::new(400,"tests","btree_test_delete_usize_as_comp");
        btree.set_up();
        for i in 0..50 {
            let student = Student::new("Witt", "Jonathan", i as usize);
